...
public final class CExecuteCommand extends pcore.io.Protocol{
    public static final int TYPE_ID = 15238;
    ...
    public CExecuteCommand(String module , String command , java.util.List<String> parameters ) {
        this.module = module;
