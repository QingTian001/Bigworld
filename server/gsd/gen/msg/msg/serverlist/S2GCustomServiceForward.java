...
public final class S2GCustomServiceForward extends pcore.io.Protocol{
    public static final int TYPE_ID = 6919;
    ...
    public S2GCustomServiceForward() {
         this.data = new byte[0];

    }

    public S2GCustomServiceForward(long id , byte[] data ) {
        this.id = id;
         this.data = data;
