...
public final class G2SSealAcount extends pcore.io.Protocol{
    public static final int TYPE_ID = 15549;
    ...
    public G2SSealAcount() {
         this.results = pcore.collection.Factory.newList();

    }

    public G2SSealAcount(java.util.List<msg.serverlist.SealAcountRet> results ) {
